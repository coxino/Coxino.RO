...
export class ShopComponent implements OnInit {
  ...
  CheckIfUserIsSubs(id: any) {
    var isSubs = false;
    var nextPage = "";
    var uri = "https://youtube.googleapis.com/youtube/v3/subscriptions?part=snippet&channelId="+id+"&key=AIzaSyC8wHq1TI2yBL0dM5Q3CZuIcxlMRmWPTIE&maxResults=10&pageToken="+nextPage;
    this.http.get(uri).subscribe(async (data:any)=>{  
      var chanels_first = data.items;
